...
const QUICKSWAP_V2 = "0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff" as const;
const SPOOKY_V2 = "0xF491e7B69E4244ad4002BC14e878a34207E38c29" as const;
...
export const LAUNCH_CONTRACTS: Partial<Record<(typeof ChainKey)[keyof typeof ChainKey], LaunchContracts>> = {
  ...
  [ChainKey.Optimism]: unset(),
  [ChainKey.Polygon]: unset(QUICKSWAP_V2),
  [ChainKey.Fantom]: unset(SPOOKY_V2),
  [ChainKey.Mantle]: unset(),
  [ChainKey.WorldChain]: unset(),
  [ChainKey.HyperEvm]: unset(),
  [ChainKey.Monad]: unset(),
  [ChainKey.Plasma]: unset(),
  [ChainKey.Gnosis]: unset(),
  [ChainKey.Cronos]: unset(),
  [ChainKey.Sei]: unset(),
  [ChainKey.Sonic]: unset(),
  [ChainKey.Celo]: unset(),
  [ChainKey.OpBnb]: unset(),
  [ChainKey.Unichain]: unset(),
  [ChainKey.Linea]: unset(),
  [ChainKey.Scroll]: unset(),
  [ChainKey.ZkSync]: unset(),
  [ChainKey.Blast]: unset(),
  [ChainKey.Ink]: unset(),
  [ChainKey.Soneium]: unset(),
  [ChainKey.MegaEth]: unset(),
  [ChainKey.XLayer]: unset(),
  [ChainKey.Abstract]: unset(),
  [ChainKey.Ronin]: unset(),
